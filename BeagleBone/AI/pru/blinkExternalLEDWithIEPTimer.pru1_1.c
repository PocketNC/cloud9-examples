...
// Section 30.2.11.2.2.3 PRU-ICSS Industrial Ethernet Timer Basic Programming Sequence
void setup_iep() {
  // 1. Initialize timer to known state (default values)
  CT_IEP.GLB_CFG_bit.CNT_EN = 0;
  CT_IEP.CNT = 0;
